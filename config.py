...
def get_config():
    ...
    parser.add_argument('--zipf_s', type=float, default=1.0, help='Zipf 分布参数，控制评分权重的衰减')
    ...
    parser.add_argument('--max_steps', type=int, default=100, help='每个 episode 的最大步数')
    ...
    parser.add_argument('--epsilon_decay', type=float, default=0.999, help='epsilon 衰减率')
